<template>
  <section class="relative py-20 lg:py-32 bg-gray-50 dark:bg-gray-900 transition-colors duration-300" id="code-mentor">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden rounded-2xl min-h-[500px] bg-gray-200 dark:bg-gray-800 mx-auto w-full max-w-6xl px-4" data-aos="fade-up">
          <iframe
            src="https://code-mentor-production-4d2f.up.railway.app/"
            style="width: 100%; height: 1600px; border: none; border-radius: 12px; display: block;"
      ...
      <div class="text-center mt-6 sm:mt-8 px-4" data-aos="fade-up" data-aos-delay="200">
        <div class="grid gap-6 sm:grid-cols-2 max-w-4xl mx-auto text-left">
          <div class="bg-white/70 dark:bg-gray-800/60 border border-primary/20 rounded-2xl p-6 shadow-lg">
            <h3 class="flex items-center text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-4">
              <i class="fas fa-rocket text-primary mr-3"></i>
              Realizações
            </h3>
            <ul class="space-y-2 text-sm sm:text-base text-gray-600 dark:text-gray-400">
              <li>SSE em tempo real com orquestração multiagente para feedback imediato.</li>
              <li>CI/CD no Railway com validações automáticas via Pydantic e Pytest.</li>
              <li>Infra Dockerizada e monitoramento de performance para <span class="text-primary font-semibold">~300ms</span> de resposta média.</li>
            </ul>
          </div>
          <div class="bg-white/70 dark:bg-gray-800/60 border border-primary/20 rounded-2xl p-6 shadow-lg">
            <h3 class="flex items-center text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-4">
...
.badge {
  @apply px-2 sm:px-3 py-1 bg-primary/10 text-primary text-xs sm:text-sm rounded-lg;
}
</style>
