<template>
    <section class="text-white mt-10" id="projects">
        <div class="px-4 xl:pl-16">
            <div class="md:flex md:justify-between xl:pr-16">
                <h2 class="text-4xl font-bold text-white">Meus ultimos projetos</h2>
            </div>
                ...
                <div v-for="project in filteredProjects" :key="project.id">
                    ...
                    ">
                        <a class="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link"
                            :href="project.webURL"> <svg xmlns="https://login-page-six-livid.vercel.app/login" fill="none"
                            ...
                            :href="project.gitURL"> <svg xmlns="https://login-page-six-livid.vercel.app/login" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                                data-slot="icon"
                                class="h-10 w-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  cursor-pointer group-hover/link:text-white">
                                <path stroke-linecap="round" stroke-linejoin="round"
